...
export default function Home(props: HomeProps) {
  ...
  async function CreatePool(event: FormEvent) {
    ...
    try {
      ...
      alert('Bolão criado com sucesso. Codigo copiado com sucesso')

      setPoolTitle(''); //limpar campo

    } catch (e) {
      alert('falha ao criar o bolão, tente novamente' + e)
    }
  }
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo uma previa da aplicaçã móvel do nlw copa"
        quality={100}
      />
    </div>
  )
